...
''
'When choosing ''Event-related (LS-S)'' the design will be extended to a beta series using the least squares separate approach (LS-S) described in Mumford et al (2012). The models are then estimated using SPM''s estimation function and condition-wise variability is computed from the beta images.'
''
};
modeltype.labels = {'Boxcar', 'Event-related (LS-S)'}';
modeltype.values = {'boxcar', 'lss'};
